-- Location: supabase/migrations/20250116000008_email_notifications.sql
-- Schema Analysis: Existing AI education platform with user_profiles table
-- Integration Type: addition - Email notifications system with logging
...
-- 4. RLS Policies - Admins can see all email logs, users can only see their own
DO $$ BEGIN
    CREATE POLICY "admin_full_access_email_logs"
...
-- 5. Create email_templates table for reusable templates
CREATE TABLE IF NOT EXISTS public.email_templates (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    name TEXT NOT NULL UNIQUE,
    subject TEXT NOT NULL,
    content TEXT NOT NULL,
    template_type TEXT NOT NULL DEFAULT 'default', -- default, announcement, course_update, etc.
...
-- 6. Create indexes for email_templates
DO $$ BEGIN
...
-- 8. RLS Policies for email_templates - Only admins can manage templates
DO $$ BEGIN
...
-- 10. Updated_at trigger for email_templates
DO $$ BEGIN
...
-- 11. Helper function to get email template by name
