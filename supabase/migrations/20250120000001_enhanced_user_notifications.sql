-- Enhanced User Management with WhatsApp and Notifications
-- Migration: Add WhatsApp phone field and notification capabilities
...
COMMENT ON TABLE public.notification_templates IS 'Stores reusable notification templates for emails and WhatsApp messages';
COMMENT ON TABLE public.notification_logs IS 'Tracks all notification deliveries and their status';
COMMENT ON COLUMN public.user_profiles.whatsapp_phone IS 'WhatsApp phone number for notifications (international format)';
