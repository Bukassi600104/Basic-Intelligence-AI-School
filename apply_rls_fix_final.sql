-- Apply RLS Fix for Admin User Creation - Final Version
-- This script uses proper error handling to avoid duplicate policy errors
...
-- Using DO blocks with exception handling to avoid duplicate errors
