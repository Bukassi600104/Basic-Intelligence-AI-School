...
-- This script will delete the existing student account and create a fresh admin account
...
-- Step 2: Delete related data (if user exists)
DO $$
DECLARE
...
-- Step 4: Create new admin user using Supabase Auth function
-- Note: This step needs to be done through the application or Supabase dashboard
