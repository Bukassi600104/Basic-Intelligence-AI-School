-- Update notification templates to include password in welcome messages
-- This script updates the existing welcome templates to include the generated password
