        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="/pricing" className="block text-sm text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-200">
                → Pricing
              </a>
              <a href="/courses" className="block text-sm text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-200">
                → Courses
              </a>
            </div>
          </div>
