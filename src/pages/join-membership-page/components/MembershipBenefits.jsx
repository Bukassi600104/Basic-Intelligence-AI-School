    ...
    <div className="mb-8">
          ...
          <div key={index} className="group bg-white border-2 border-gray-200 rounded-2xl p-6 hover:border-blue-400 hover:shadow-xl transition-all hover:-translate-y-1 animate-slideUp" style={{ animationDelay: `${0.1 * index}s` }}>
            <div className="flex items-start space-x-4">
              <div className={`w-14 h-14 bg-gradient-to-br ${
                index % 6 === 0 ? 'from-orange-500 to-orange-600' :
                index % 6 === 1 ? 'from-orange-500 to-pink-600' :
                index % 6 === 2 ? 'from-orange-500 to-green-600' :
              ...
              <div className="flex-1">
                ...
                <span className="inline-flex items-center px-3 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-orange-50 to-orange-50 text-orange-600 border border-orange-200">
      ...
      <div className="mt-8 relative overflow-hidden rounded-2xl bg-white border-2 border-emerald-200 p-8 text-center hover:border-emerald-400 hover:shadow-xl transition-all animate-slideUp" style={{ animationDelay: '0.7s' }}>
        ...
        <div className="relative">
          <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-4 animate-pulse-slow">
          ...
          <p className="text-gray-600 leading-relaxed max-w-xl mx-auto">
            Join <span className="font-bold text-orange-600">thousands of Nigerian professionals</span> who are already using AI to advance their careers and grow their businesses.
          </p>
        </div>
      </div>
    </div>
