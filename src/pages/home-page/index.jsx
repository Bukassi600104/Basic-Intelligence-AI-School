            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-muted-foreground mb-4 max-w-md">
                  Empowering Nigerians with practical AI education and skills development. 
                  Join our community of learners and professionals transforming their careers with AI.
                </p>
                <div className="flex items-center space-x-4">
                  <button className="p-2 rounded-md text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors duration-200">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="/about-page" className="text-muted-foreground hover:text-primary transition-colors duration-200">
                      About Us
                    </a>
                  </li>
                  <li>
                    <a href="/join-membership-page" className="text-muted-foreground hover:text-primary transition-colors duration-200">
                      Join Membership
                    </a>
                  </li>
                  <li>
                    <a href="/contact-page" className="text-muted-foreground hover:text-primary transition-colors duration-200">
                      Contact
                    </a>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span className="text-sm">support@basicintelligence.ng</span>
                  </li>
                  <li className="flex items-center space-x-2">
